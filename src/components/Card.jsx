...
function Card3({ h1, img, a }) {
  return (
    <div className="text-center pl-[20px] pr-[20px] mt-[10px] sm:pt-[10px] sm:ml-[50px] sm:pl-0 lg:w-[400px]">
      <img src={img} alt="error" className="m-auto" />
      <div className="flex justify-between items-center pr-[25px] pl-[25px] sm:pl-0">
        <h1 className="font-black text-[20px] mt-[5px] mb-[5px]">{h1}</h1>
        <a href={a}>
          <Git />
        </a>
      </div>
